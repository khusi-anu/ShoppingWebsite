   	...
   	<div class="row header-inner">
	      ...
	      <nav id="nav-wrap">         
	         ...
	         <ul id="nav" class="nav">
				...
				<img src='<?php echo $row['path']; ?>' height="255" width="175" />
