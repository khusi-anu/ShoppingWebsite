...
session_start();
       if(isset($_SESSION['fname'])){
		   if($_SERVER['REQUEST_TIME']-$_SESSION['time']<30000){
			   ...
			   define('DB_HOST', 'localhost'); 
				...
				//$temp = $_SESSION['email'];
			//	$sql = "select * from users where id='$temp'";
...
<body class="homepage">
   ...
   <header id="main-header">
   	...
   	<div class="row header-inner">
	      ...
	      <div class="logo">
	         <a class="smoothscroll" href="#hero">CoolPick</a>
	      </div>
	      ...
	      <nav id="nav-wrap">         
	         ...
	         <ul id="nav" class="nav">
	            <li class="current"><a class="smoothscroll" href="#hero">Home.</a></li>
		         <li><a class="smoothscroll" href="#portfolio">Pick</a></li>
	            <li><a class="smoothscroll" href="#services">Services.</a></li>
	            <li><a class="smoothscroll" href="#about">About.</a></li>
	            <li><a class="smoothscroll" href="#journal">Blog.</a></li>	            
	            <li><a class="smoothscroll" href="#contact">Contact.</a></li>
				<button onClick="window.location.href='reg/logout.php'"> Logout</button>;
				   ...
				   <ul class="slides">
					   ...
					   <li>
						   <div class="flex-caption">
								<h1>Hello, we are CoolPick. We sell awesome and stunning stuffs.</h1>	
					   ...
					   <li>
						   <div class="flex-caption">
								<h1 >Take a look at some of <a class="smoothscroll" href="#portfolio" title="">our Goods</a> or <a class="smoothscroll" href="#contact" title="">contact us</a> to discuss how we can help you.</h1>
   ...
   <section id="portfolio">
      ...
      <div class="row section-head">
      	...
      	<div class="twelve columns">
	         ...
	         <h1>Our Latest Products<span>.</span></h1>

	         <hr />

	         <p>We respect your choices and here we are to serve you better. Our products maps your requirements to a whole new level.  
	         </p>
            ...
            <div id="portfolio-wrapper" class="bgrid-fourth s-bgrid-third mob-bgrid-half group">
          	   ...
          	   <div class="bgrid item">
                  <div class="item-wrap">
                     ...
                     <a href="shopper_in/index1men.php">
                        <img src="images/portfolio/m1.jpg" alt="Grizzly">
               ...
               <div class="bgrid item">
                  <div class="item-wrap">
                     ...
                     <a href="shopper_in/index1purse.php">
                        <img src="images/portfolio/p1.jpg" alt="Hotel Sign">
                        <div class="overlay">
                        	<div class="portfolio-item-meta">
          					      <h5>FASHION</h5>
                              <p>Purse</p>
               ...
               <div class="bgrid stack item">
                  <div class="item-wrap">
                     ...
                     <a href="shopper_in/index1laptops.php">
                        <img src="images/portfolio/e2.jpg" alt="Beetle">                        
                        <div class="overlay">
                        	<div class="portfolio-item-meta">
          					      <h5>ELECTRONICS</h5>
                              <p>laptops</p>
               ...
               <div class="bgrid item">
                  <div class="item-wrap">
                     ...
                     <a href="shopper_in/index1women.php">
                        <img src="images/portfolio/w3.jpg" alt="Banjo Player">
                        <div class="overlay">
                        	<div class="portfolio-item-meta">
          					      <h5>FASHION</h5>
                              <p>Women's Wear</p>
               ...
               <div class="bgrid item">
                  <div class="item-wrap">
                     ...
                     <a href="shopper_in/index1furni.php">
                     	<img src="images/portfolio/f1.jpg" alt="Coffee Cup">
                       	<div class="overlay">
                       		<div class="portfolio-item-meta">
          					      <h5>ASSETS</h5>
                              <p>furnitures</p>
               ...
               <div class="bgrid item">
                  <div class="item-wrap">
                     ...
                     <a href="shopper_in/index1kids.php">
                        <img src="images/portfolio/k1.jpg" alt="Farmerboy">
                        <div class="overlay">
                        	<div class="portfolio-item-meta">
          					      <h5>FASHION</h5>
                              <p>Kids wear</p>
               ...
               <div class="bgrid item">
                  <div class="item-wrap">
                     ...
                     <a href="shopper_in/index1mobiles.php">                        
                        <img src="images/portfolio/mo1.jpg" alt="Judah">                       
                        <div class="overlay">
                        	<div class="portfolio-item-meta">
          					      <h5>ELECTRONICS</h5>
                              <p>Mobiles</p>
               ...
               <div class="bgrid item">
                  <div class="item-wrap">
                     ...
                     <a href="shopper_in/index1cosmetics.php">
                        <img src="images/portfolio/c1.jpg" alt="Embossed Paper">
                        <div class="overlay">
                        	<div class="portfolio-item-meta">
          					      <h5>FASHION</h5>
                              <p>Cosmetics</p>
	      	...
	      	<div class="service-list bgrid-third s-bgrid-half mob-bgrid-whole">
	      		...
	      		<div class="bgrid">
	               ...
	               <div class="service-content">	                  
		               <p>Our offline stores are opening up at several places acroos INDIA.
	         			</p> 
	               </div>      
		         ...
		         <div id="team-wrapper" class="bgrid-half mob-bgrid-whole group">
		            ...
		            <div class="bgrid member">
		               ...
		               <ul class="member-social">
		                  <li><a href="https:/www.facebook.com/anu.gupta"><i class="fa fa-facebook"></i></a><?php echo "&nbsp;&nbsp; Welcome <strong>".$_SESSION['fname']."</strong>"; ?></li>
    ...
    <footer>
      ...
      <div class="row">       
         ...
         <div class="six columns tab-whole footer-about">
				...
				<h3>About CoolPick</h3>
               
            <p>Awesome Products finally revealed.CoolPick always look forward to your choices and views.Do contact us to get to know in advance about the coolest range of products.
            </p>

            <p>Have the amazing experience with coolpicks.If you like our goods and services,do give us a feedback.</p>        
         ...
         <div class="six columns tab-whole right-cols">
            ...
            <div class="row">
               ...
               <div class="columns">
                  ...
                  <ul>
                    <li><a href="tel:6473438234">+91-8547123620</a></li>
                    <li><a href="tel:1234567890">+91-7845692010</a></li>
                    <li><a href="mailto:someone@puremedia.com">someone@coolpicks.com</a></li>
                  </ul>                  
               </div> <!-- /columns -->             
         ...
         <p class="copyright">&copy;  Copyright 2017 CoolPicks. Design by <a href="http://www.styleshout.com/">Styleshout.</a></p>        
   ...
   <script src="js/main.js"></script>
	   ...
	   <?php
		   ...
		   print "<script>window.location.href='reg/reg.html';</script>";
